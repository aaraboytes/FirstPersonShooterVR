...
namespace UnrealFPS.Editor
{
    public partial class ProjectSetupAssistant
    {
        ...
        public struct ItemProperty : IEquatable<ItemProperty>
        {
            ...
            /// <param name="isReady">Item ready state.</param>
            internal ItemProperty(int id, int index, string name, ItemType type, Action onEnable, Action onGUI, bool isReady)
            {
                this.id = id;
                this.index = index;
                this.name = name;
            ...
            /// <summary>
            /// Set item ready state.
            /// </summary>
            /// <param name="value"></param>
            public void IsReady(bool value)
            {
                isReady = value;
            }
            ...
            /// </summary>
            /// <returns></returns>
            public readonly static ItemProperty Empty = new ItemProperty(-1, -1, "", ItemType.Optional, () => { }, () => { }, true);
            ...
            {
                return (id, index, name, itemType, onEnable, onGUI, isReady) == (other.id, other.index, other.name, other.itemType, other.onEnable, other.onGUI, other.isReady);
            }

            public override int GetHashCode()
            {
                return (id, index, name, itemType, onEnable, onGUI, isReady).GetHashCode();
            }
        }
    }
}